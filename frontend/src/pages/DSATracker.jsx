      ...
      <div className="max-w-6xl mx-auto p-8">
        ...
        <div className="flex justify-between items-center mb-6">
          <div>
            ...
            <p className="text-sm mt-1" style={{ color: '#4a6fa5' }}>{problems.length} problems tracked</p>
          </div>
          <button
        ...
        <div className="bg-white rounded-xl shadow-sm overflow-hidden" style={{ border: '1.5px solid #c5d5ea' }}>
          {problems.length === 0 ? (
            <div className="p-12 text-center">
              ...
              <p className="font-medium" style={{ color: '#1a3a6b' }}>No problems tracked yet</p>
              <p className="text-sm mt-1" style={{ color: '#4a6fa5' }}>Click "Add Problem" to get started</p>
            </div>
          ) : (
                ...
                {problems.map((p, i) => (
                  ...
                  >
                    <td className="px-4 py-3 font-medium" style={{ color: '#1a3a6b' }}>
                      {p.url ? (
                        <a href={p.url} target="_blank" rel="noreferrer" className="hover:underline" style={{ color: '#2e86de' }}>
                          {p.title}
                        </a>
                      ) : p.title}
                    </td>
